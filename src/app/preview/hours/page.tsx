    ...
    <div className="min-h-dvh bg-[#140a1c] px-4 py-6 text-orange-50" dir="rtl">
      <div className="mx-auto max-w-lg space-y-5">
        <header className="space-y-2">
          <p className="text-xs text-violet-300">{config.appName} · תצוגת שעות</p>
            ...
            return (
              ...
              >
                ...
                <div className="rounded-xl bg-[#140a1c]/70 p-3 ring-1 ring-orange-500/10">
                  <p className="text-sm font-medium text-orange-100">{demoHouse.name}</p>
                  <p className="mt-1 text-sm text-violet-200" dir="ltr">
                    {formatHoursLabel(demoHouse)}
                  </p>
                  <div className="mt-2">
                    <HoursStatusBanner house={demoHouse} now={item.now} className="text-sm" />
                    {status.kind === "open" ? (
