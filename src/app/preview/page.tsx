    ...
    <div className="min-h-dvh bg-[#140a1c] px-4 py-6 text-orange-50" dir="rtl">
      <div className="mx-auto max-w-lg space-y-6">
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-base text-violet-300">קו דק מקצה לקצה, כמו בתמונה המקורית.</p>
          <div className="flex flex-wrap items-end gap-4">
            {SENSITIVITY_KINDS.map((kind) => (
              <div key={kind.id} className="flex flex-col items-center gap-1">
                ...
                <span className="max-w-20 text-center text-base leading-tight text-violet-300">
                  {kind.label}
                </span>
              </div>
            ))}
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-base text-violet-300">אפור עם קו = הבית בלי ממתקים מההתחלה.</p>
          <div className="flex flex-wrap items-end gap-4">
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-base text-violet-300">ירוק / כתום / אדום — כמו רמת הפחד, עם דלעת.</p>
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex flex-col items-center gap-1">
