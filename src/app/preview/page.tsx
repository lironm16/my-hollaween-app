      ...
      <div className="mx-auto max-w-lg space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-sm text-violet-200">
            כאן רואים רגישויות, ממתקים, פחד וקישוט בלי לחכות לתמונות גדולות. פחד = רוח רפאים.
            קישוט = אורות בחוץ. אפור עם קו בקישוט = לא מקושט.
          </p>
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-xs text-violet-300">אורות בחוץ, לא רוח. אפור עם קו = לא מקושט.</p>
          <div className="flex flex-wrap items-end gap-4">
