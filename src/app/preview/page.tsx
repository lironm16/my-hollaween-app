      ...
      <div className="mx-auto max-w-lg space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-sm text-violet-200">
            כאן רואים רגישויות, ממתקים ופחד. אפור עם קו = לא מקושט, עכשיו בתוך רמת פחד.
          </p>
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-sm text-violet-300">קו דק מקצה לקצה, כמו בתמונה המקורית.</p>
          <div className="flex flex-wrap items-end gap-4">
            {SENSITIVITY_KINDS.map((kind) => (
              <div key={kind.id} className="flex flex-col items-center gap-1">
                ...
                <span className="max-w-20 text-center text-sm leading-tight text-violet-300">
                  {kind.label}
                </span>
              </div>
            ))}
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-sm text-violet-300">אפור עם קו = הבית בלי ממתקים מההתחלה.</p>
          <div className="flex flex-wrap items-end gap-4">
        ...
        <section className="space-y-3 rounded-2xl bg-[#1d1028] p-4 ring-1 ring-orange-500/20">
          ...
          <p className="text-sm text-violet-300">ירוק = לילדים. אפור עם קו = לא מקושט.</p>
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex flex-col items-center gap-1">
              <ScareSign level="none" className="size-12" />
              <span className="text-sm text-violet-300">לא מקושט</span>
            </div>
