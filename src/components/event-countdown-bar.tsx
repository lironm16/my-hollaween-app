...
export function EventCountdownBar({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      aria-label={`${parts.label} — פתיחת מסך ספירה`}
      className={cn(
      ...
      dir="ltr"
    >
      <span className="event-countdown-bar__text inline-flex max-w-full items-baseline justify-center gap-0 whitespace-nowrap font-creepster tabular-nums tracking-wide text-orange-400 [text-shadow:0_0_10px_rgba(251,146,60,0.35)]">
